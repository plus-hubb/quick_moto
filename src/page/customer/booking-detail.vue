    ...
    <div v-else-if="booking" class="w-full max-w-2xl mx-auto px-4 pt-6">
      ...
      <section class="bg-blue-50 border border-blue-100 rounded-2xl p-4 mb-6">
        <div class="flex items-start gap-2">
          ...
          <div class="space-y-3">
            <div>
              <h3 class="text-sm font-bold text-slate-900 mb-1.5">คำแนะนำการรับรถ</h3>
              <ul class="text-xs text-slate-600 leading-relaxed space-y-1 list-disc pl-4">
                <li>ผู้เช่าต้องมารับรถภายในวันที่กำหนดเช่าและภายในเวลาทำการของร้าน</li>
                <li>ผู้เช่าต้องเตรียมเอกสารสำหรับการเช่า ได้แก่ บัตรประชาชน ใบขับขี่ และบัตรนิสิต</li>
                <li>ก่อนรับรถ ผู้เช่าควรตรวจสอบสภาพรถร่วมกับทางร้าน</li>
                <li>ทางร้านจะบันทึกรอยขีดข่วน ระดับน้ำมัน และเลขไมล์ของรถก่อนส่งมอบ</li>
                <li>ผู้เช่าควรตรวจสอบข้อมูลการเช่าและสภาพรถให้เรียบร้อยก่อนรับรถ</li>
                <li>หากพบความผิดปกติหรือความเสียหาย ควรแจ้งทางร้านก่อนนำรถออกจากร้าน</li>
              </ul>
            </div>
            <div>
              <h3 class="text-sm font-bold text-slate-900 mb-1.5">คำแนะนำการคืนรถ</h3>
              <ul class="text-xs text-slate-600 leading-relaxed space-y-1 list-disc pl-4">
                <li>ผู้เช่าต้องนำรถมาคืนตามวันที่และเวลาที่กำหนด</li>
                <li>ก่อนคืนรถ ผู้เช่าควรตรวจสอบระดับน้ำมันให้เรียบร้อย</li>
                <li>ทางร้านจะตรวจสอบระดับน้ำมัน ความเสียหาย และเลขไมล์ของรถเมื่อรับคืน</li>
                <li>สภาพรถหลังคืนจะถูกนำไปเปรียบเทียบกับข้อมูลที่บันทึกไว้ก่อนส่งมอบ</li>
                <li>หากคืนรถล่าช้า จะมีค่าปรับในอัตรา 50 บาทต่อชั่วโมง</li>
                <li>หากรถมีความเสียหาย ผู้เช่าต้องแจ้งให้ทางร้านทราบเพื่อดำเนินการตามเงื่อนไขการเช่า</li>
                <li>หลังจากทางร้านตรวจสอบและยืนยันการคืนรถแล้ว รายละเอียดการเช่าและค่าปรับ (ถ้ามี) จะถูกบันทึกไว้ในประวัติการเช่า</li>
              </ul>
            </div>
          </div>
        </div>
