<template>
  <div class="bg-slate-100 min-h-screen font-kanit pb-28">
    ...
    <div v-else-if="vehicle" class="w-full max-w-2xl mx-auto px-4">

      <!-- Vehicle Image + Info -->
      <div class="pt-5">
        <div class="w-full h-56 sm:h-72 bg-slate-200 rounded-2xl overflow-hidden">
          <img
            v-if="vehicle.image"
            :src="vehicle.image"
      ...
      <section class="bg-white rounded-2xl p-5 shadow-sm border border-slate-100 mb-6">
        ...
        <div class="text-sm text-slate-600 leading-relaxed space-y-2" :class="{ 'line-clamp-4': !showFullTerms }">
          <p>1. ผู้เช่าต้องชำระค่ามัดจำการจองจำนวน 500 บาท เพื่อยืนยันการจองรถ</p>
          <p>2. ผู้เช่าต้องแสดงบัตรประชาชน ใบขับขี่ ตามที่ร้านกำหนดในขั้นตอนการเช่ารถ</p>
          <p>3. ผู้เช่าต้องมารับรถภายในวันที่กำหนดเช่า และภายในเวลาทำการของร้าน</p>
          <p>4. ก่อนส่งมอบรถ จะมีการตรวจสอบและบันทึกสภาพรถ ได้แก่ รอยขีดข่วน ระดับน้ำมัน และเลขไมล์ของรถ</p>
          <p>5. ผู้เช่าต้องคืนรถตามวันที่และเวลาที่กำหนด หากคืนรถล่าช้า จะมีค่าปรับในอัตรา 50 บาทต่อชั่วโมง</p>
          <p>6. ในการคืนรถ ทางร้านจะตรวจสอบระดับน้ำมัน ความเสียหายของรถ และเลขไมล์ เพื่อเปรียบเทียบกับข้อมูลก่อนส่งมอบรถ</p>
          <p>7. กรณีผู้เช่ายกเลิกการจอง ทางร้านไม่มีนโยบายคืนเงินค่ามัดจำการจอง</p>
          <p>8. หากรถเกิดความเสียหายบริเวณยาง ผู้เช่าต้องรับผิดชอบค่าใช้จ่ายที่เกิดขึ้นเอง</p>
          <p>9. หากรถเกิดความเสียหายในกรณีอื่นนอกเหนือจากยาง ทางร้านจะพิจารณาดำเนินการเปลี่ยนรถให้ตามเงื่อนไขของร้าน</p>
          <p>10. กรณีเกิดอุบัติเหตุ ผู้เช่าต้องรับผิดชอบค่าเสียหายตามเงื่อนไขของร้าน และสามารถดำเนินการเบิกประกันจาก พ.ร.บ. รถได้ตามกรณี</p>
          <p>11. ผู้เช่าต้องตรวจสอบรายละเอียดการเช่าและเงื่อนไขต่าง ๆ ก่อนยืนยันการจอง และถือว่าการยืนยันการจองเป็นการยอมรับข้อตกลงการเช่ารถ</p>
        </div>
